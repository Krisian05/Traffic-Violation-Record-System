...
<div class="d-flex align-items-center gap-2 mb-4">
    <div class="rounded-circle d-flex align-items-center justify-content-center"
        ...
        <i class="bi bi-person-plus-fill text-white" style="font-size:1rem;"></i>
    </div>
    <div>
        <h5 class="mb-0 fw-700" style="color:#1c1917;">Add Motorist</h5>
        <div style="font-size:.8rem;color:#78716c;">Register a new motorist profile</div>
    </div>
</div>

<form method="POST" action="{{ route('violators.store') }}" enctype="multipart/form-data" id="motoristForm" novalidate>
@csrf
@if(old('incident_motorist_id'))
    <input type="hidden" name="incident_motorist_id" value="{{ old('incident_motorist_id') }}">
@endif
...
<div class="vlt-section-card">
    <div class="vlt-card-header">
        ...
        <div>
            ...
            <div class="vlt-section-sub">Basic details &amp; identification</div>
        </div>
    </div>
    <div class="card-body">
        <div class="row g-3">
            ...
            <div class="col-12 d-flex align-items-start gap-4 mb-2">
                ...
                <div class="flex-fill">
                    ...
                    <small class="vlt-hint"><i class="bi bi-info-circle"></i> JPG or PNG only, max 20 MB. Clear front-facing photo.</small>
                </div>
            </div>
            ...
            <div class="col-md-8">
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="place_of_birth"
                        ...
                        value="{{ old('place_of_birth') }}" placeholder="e.g. Dagupan City, Pangasinan">
            ...
            <div class="col-md-3">
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="height" id="height"
                        ...
                        value="{{ old('height') }}" placeholder='e.g. 5&apos;8"'>
            ...
            <div class="col-md-6">
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="valid_id"
                        ...
                        value="{{ old('valid_id') }}" placeholder="e.g. SSS, UMID, Passport">
            ...
            <div class="col-md-6">
                ...
                <div class="input-group align-items-start">
                    ...
                    <textarea name="temporary_address" class="form-control @error('temporary_address') is-invalid @enderror"
                        rows="2" placeholder="Blk/Lot, Street, Barangay, City/Municipality">{{ old('temporary_address') }}</textarea>
            ...
            <div class="col-md-6">
                ...
                <div class="input-group align-items-start">
                    ...
                    <textarea name="permanent_address" class="form-control @error('permanent_address') is-invalid @enderror"
                        rows="2" placeholder="Blk/Lot, Street, Barangay, City/Municipality">{{ old('permanent_address') }}</textarea>
    ...
    <div class="card-body">
        <div class="row g-3">
            ...
            <div class="col-md-6">
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="license_number" id="license_number"
                        ...
                        value="{{ old('license_number') }}" placeholder="N01-23-456789"
            ...
            <div class="col-md-4">
                ...
                @php $oldCodes = (array) old('license_restriction', []); @endphp
                <div class="input-group">
            ...
            <div class="col-md-4">
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="license_issued_date" id="dp-issued"
                        ...
                        value="{{ old('license_issued_date') }}" placeholder="YYYY-MM-DD">
            ...
            <div class="col-md-4">
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="license_expiry_date" id="dp-expiry"
                        ...
                        value="{{ old('license_expiry_date') }}" placeholder="YYYY-MM-DD">
            ...
            <div class="col-12">
                ...
                <div class="input-group align-items-start">
                    ...
                    <textarea name="license_conditions" class="form-control @error('license_conditions') is-invalid @enderror"
                        rows="2" placeholder="e.g. Corrective lenses must be worn while driving">{{ old('license_conditions') }}</textarea>
...
<div class="d-flex gap-2 mb-4">
    <button type="submit" class="vlt-form-submit">
        <i class="bi bi-check-lg me-1"></i> Save Motorist
    </button>
    <a href="{{ route('violators.index') }}" class="btn d-inline-flex align-items-center gap-2 rounded-pill" style="border:1.5px solid #d6d3d1;color:#78716c;background:#fff;font-weight:500;"><i class="bi bi-x-circle" style="font-size:.85rem;"></i> Cancel</a>
</div>
...
(function () {
    ...
    if (licenseEl) {
        licenseEl.addEventListener('input', function () {
            ...
            // LTO license pattern: letter + digits + dashes
    ...
    // Hook called after flatpickr sets the value
