...
<form method="POST" action="{{ route('violations.update', $violation) }}" enctype="multipart/form-data" id="violationEditForm">
@csrf @method('PUT')
...
<script>
    ...
    document.getElementById('violationEditForm').addEventListener('submit', function () {
