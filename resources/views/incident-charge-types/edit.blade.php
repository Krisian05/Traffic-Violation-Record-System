@extends('layouts.app')
@section('title', 'Edit Charge Type')
...
@section('breadcrumbs')
    ...
    <li class="breadcrumb-item active" aria-current="page">Edit {{ $chargeType->name }}</li>
@endsection
...
<div class="ict-form-card">
    ...
    <div class="ict-form-header">
        <span class="ict-form-icon" style="background:linear-gradient(135deg,#d97706,#b45309);box-shadow:0 3px 10px rgba(180,83,9,.35);">
            <i class="bi bi-pencil-fill" style="color:#fff;font-size:.9rem;"></i>
        </span>
        <div>
            <div class="ict-form-title">Edit Charge Type</div>
            <div class="ict-form-sub">{{ $incidentChargeType->name }}</div>
        </div>
    </div>

    <div class="ict-form-body">
        <form method="POST" action="{{ route('incident-charge-types.update', $incidentChargeType) }}">
            @csrf @method('PUT')
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="name"
                           ...
                           value="{{ old('name', $incidentChargeType->name) }}"
                           required>
            ...
            <div class="mb-4">
                ...
                <div class="input-group align-items-start">
                    ...
                    <textarea name="description"
                              ...
                              rows="3">{{ old('description', $incidentChargeType->description) }}</textarea>
            ...
            <div class="d-flex gap-2 pt-2">
                <button type="submit" class="ict-submit-btn">
                    <i class="bi bi-check-lg"></i> Update Charge Type
                </button>
...
.ict-input:focus { box-shadow: none; border-color: #e2d9cf; }
...
.ict-submit-btn:hover { transform: translateY(-1px); box-shadow: 0 4px 14px rgba(180,83,9,.45); }
</style>
